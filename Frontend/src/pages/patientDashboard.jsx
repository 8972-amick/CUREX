      ...
      <main className="p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300">
            Track your appointments, health tasks, and active care.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
          {[
            ...
            <div
              key={item.label}
              className="bg-white dark:bg-slate-800 rounded-xl p-5 shadow-sm hover:shadow-md transition"
            >
          ...
          {loading ? (
            ...
            <div>
              <p>
                ...
                {nextAppointment.doctor?.name || "Unknown"}
              </p>
              <p>
                <strong>Date:</strong>{" "}
                {new Date(
            ...
            <p className="text-gray-600">
              No approved upcoming appointment.
            </p>
          )}
        </section>
